...
export default function about() {
    return (
        <div className="aboutContent">
            ...
            <p className="pAbout">
            The villager that appears on a mystery island is not affected in any way by the villager’s personality type, and you are able to see the villager that just moved out on an island. The only villagers you won’t be able to see are the villagers you already have! 
            </p>
            <p className="pAbout">
